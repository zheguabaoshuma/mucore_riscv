...
ffffffffc020006e:	61c030ef          	jal	ra,ffffffffc020368a <vmm_init>
...
ffffffffc02000ac:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000ae:	68f030ef          	jal	ra,ffffffffc0203f3c <vprintfmt>
    return cnt;
}
...
ffffffffc02000e2:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000e4:	659030ef          	jal	ra,ffffffffc0203f3c <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc0200108:	33c50513          	addi	a0,a0,828 # ffffffffc0204440 <etext+0x28>
void print_kerninfo(void) {
...
ffffffffc020011e:	34650513          	addi	a0,a0,838 # ffffffffc0204460 <etext+0x48>
ffffffffc0200122:	f99ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc0200126:	00004597          	auipc	a1,0x4
ffffffffc020012a:	2f258593          	addi	a1,a1,754 # ffffffffc0204418 <etext>
ffffffffc020012e:	00004517          	auipc	a0,0x4
ffffffffc0200132:	35250513          	addi	a0,a0,850 # ffffffffc0204480 <etext+0x68>
...
ffffffffc0200146:	35e50513          	addi	a0,a0,862 # ffffffffc02044a0 <etext+0x88>
...
ffffffffc020015a:	36a50513          	addi	a0,a0,874 # ffffffffc02044c0 <etext+0xa8>
...
ffffffffc0200188:	35c50513          	addi	a0,a0,860 # ffffffffc02044e0 <etext+0xc8>
}
...
ffffffffc0200196:	37e60613          	addi	a2,a2,894 # ffffffffc0204510 <etext+0xf8>
ffffffffc020019a:	04e00593          	li	a1,78
ffffffffc020019e:	00004517          	auipc	a0,0x4
ffffffffc02001a2:	38a50513          	addi	a0,a0,906 # ffffffffc0204528 <etext+0x110>
void print_stackframe(void) {
...
ffffffffc02001b2:	39260613          	addi	a2,a2,914 # ffffffffc0204540 <etext+0x128>
ffffffffc02001b6:	00004597          	auipc	a1,0x4
ffffffffc02001ba:	3aa58593          	addi	a1,a1,938 # ffffffffc0204560 <etext+0x148>
ffffffffc02001be:	00004517          	auipc	a0,0x4
ffffffffc02001c2:	3aa50513          	addi	a0,a0,938 # ffffffffc0204568 <etext+0x150>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02001d0:	3ac60613          	addi	a2,a2,940 # ffffffffc0204578 <etext+0x160>
ffffffffc02001d4:	00004597          	auipc	a1,0x4
ffffffffc02001d8:	3cc58593          	addi	a1,a1,972 # ffffffffc02045a0 <etext+0x188>
ffffffffc02001dc:	00004517          	auipc	a0,0x4
ffffffffc02001e0:	38c50513          	addi	a0,a0,908 # ffffffffc0204568 <etext+0x150>
ffffffffc02001e4:	ed7ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
ffffffffc02001e8:	00004617          	auipc	a2,0x4
ffffffffc02001ec:	3c860613          	addi	a2,a2,968 # ffffffffc02045b0 <etext+0x198>
ffffffffc02001f0:	00004597          	auipc	a1,0x4
ffffffffc02001f4:	3e058593          	addi	a1,a1,992 # ffffffffc02045d0 <etext+0x1b8>
ffffffffc02001f8:	00004517          	auipc	a0,0x4
ffffffffc02001fc:	37050513          	addi	a0,a0,880 # ffffffffc0204568 <etext+0x150>
...
ffffffffc0200236:	3ae50513          	addi	a0,a0,942 # ffffffffc02045e0 <etext+0x1c8>
kmonitor(struct trapframe *tf) {
...
ffffffffc0200258:	3b450513          	addi	a0,a0,948 # ffffffffc0204608 <etext+0x1f0>
...
ffffffffc020027e:	3b648493          	addi	s1,s1,950 # ffffffffc0204630 <etext+0x218>
        if (argc == MAXARGS - 1) {
ffffffffc0200282:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200284:	00004b17          	auipc	s6,0x4
ffffffffc0200288:	3b4b0b13          	addi	s6,s6,948 # ffffffffc0204638 <etext+0x220>
        argv[argc ++] = buf;
ffffffffc020028c:	00004a17          	auipc	s4,0x4
ffffffffc0200290:	2d4a0a13          	addi	s4,s4,724 # ffffffffc0204560 <etext+0x148>
    for (i = 0; i < NCOMMANDS; i ++) {
ffffffffc0200294:	4a8d                	li	s5,3
        if ((buf = readline("")) != NULL) {
ffffffffc0200296:	854a                	mv	a0,s2
ffffffffc0200298:	026040ef          	jal	ra,ffffffffc02042be <readline>
...
ffffffffc02002ba:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002bc:	0fe040ef          	jal	ra,ffffffffc02043ba <strcmp>
...
ffffffffc02002ce:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002d0:	0ea040ef          	jal	ra,ffffffffc02043ba <strcmp>
...
ffffffffc020030e:	0ca040ef          	jal	ra,ffffffffc02043d8 <strchr>
...
ffffffffc020034c:	08c040ef          	jal	ra,ffffffffc02043d8 <strchr>
...
ffffffffc020036a:	2f250513          	addi	a0,a0,754 # ffffffffc0204658 <etext+0x240>
...
ffffffffc02004b6:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc02004b8:	749030ef          	jal	ra,ffffffffc0204400 <memcpy>
    return 0;
}
...
ffffffffc02004da:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02004dc:	725030ef          	jal	ra,ffffffffc0204400 <memcpy>
    return 0;
}
...
ffffffffc0200546:	0141                	addi	sp,sp,16
        return do_pgfault(check_mm_struct, tf->cause, tf->badvaddr);
ffffffffc0200548:	71a0306f          	j	ffffffffc0203c62 <do_pgfault>
    panic("unhandled page fault.\n");
...
ffffffffc0201760:	48f020ef          	jal	ra,ffffffffc02043ee <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0201802:	3ed020ef          	jal	ra,ffffffffc02043ee <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0201f60:	448020ef          	jal	ra,ffffffffc02043a8 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0201f64:	10040593          	addi	a1,s0,256
ffffffffc0201f68:	10000513          	li	a0,256
ffffffffc0201f6c:	44e020ef          	jal	ra,ffffffffc02043ba <strcmp>
...
ffffffffc0201fa2:	10068023          	sb	zero,256(a3) # fffffffffff80100 <end+0x3fd6eb94>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0201fa6:	3cc020ef          	jal	ra,ffffffffc0204372 <strlen>
...
ffffffffc0202934:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202936:	42e010ef          	jal	ra,ffffffffc0203d64 <swapfs_init>
...
ffffffffc02029ec:	2e3000ef          	jal	ra,ffffffffc02034ce <mm_create>
...
ffffffffc0202a20:	2f7000ef          	jal	ra,ffffffffc0203516 <vma_create>
...
ffffffffc0202a2c:	359000ef          	jal	ra,ffffffffc0203584 <insert_vma_struct>
...
ffffffffc0202c36:	21f000ef          	jal	ra,ffffffffc0203654 <mm_destroy>
...
ffffffffc0203040:	5f7000ef          	jal	ra,ffffffffc0203e36 <swapfs_write>
...
ffffffffc02030a0:	06800593          	li	a1,104
...
ffffffffc02030de:	4bf000ef          	jal	ra,ffffffffc0203d9c <swapfs_read>
...
ffffffffc020311a:	07e00593          	li	a1,126
...
ffffffffc02031f6:	7d668693          	addi	a3,a3,2006 # ffffffffc02059c8 <default_pmm_manager+0x870>
ffffffffc02031fa:	00002617          	auipc	a2,0x2
ffffffffc02031fe:	bae60613          	addi	a2,a2,-1106 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203202:	09000593          	li	a1,144
ffffffffc0203206:	00003517          	auipc	a0,0x3
ffffffffc020320a:	97250513          	addi	a0,a0,-1678 # ffffffffc0205b78 <default_pmm_manager+0xa20>
ffffffffc020320e:	966fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==6);
ffffffffc0203212:	00003697          	auipc	a3,0x3
ffffffffc0203216:	9b668693          	addi	a3,a3,-1610 # ffffffffc0205bc8 <default_pmm_manager+0xa70>
ffffffffc020321a:	00002617          	auipc	a2,0x2
ffffffffc020321e:	b8e60613          	addi	a2,a2,-1138 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203222:	0a900593          	li	a1,169
ffffffffc0203226:	00003517          	auipc	a0,0x3
ffffffffc020322a:	95250513          	addi	a0,a0,-1710 # ffffffffc0205b78 <default_pmm_manager+0xa20>
ffffffffc020322e:	946fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc0203232:	00003697          	auipc	a3,0x3
ffffffffc0203236:	96e68693          	addi	a3,a3,-1682 # ffffffffc0205ba0 <default_pmm_manager+0xa48>
ffffffffc020323a:	00002617          	auipc	a2,0x2
ffffffffc020323e:	b6e60613          	addi	a2,a2,-1170 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203242:	0a700593          	li	a1,167
ffffffffc0203246:	00003517          	auipc	a0,0x3
ffffffffc020324a:	93250513          	addi	a0,a0,-1742 # ffffffffc0205b78 <default_pmm_manager+0xa20>
ffffffffc020324e:	926fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc0203252:	00003697          	auipc	a3,0x3
ffffffffc0203256:	93e68693          	addi	a3,a3,-1730 # ffffffffc0205b90 <default_pmm_manager+0xa38>
ffffffffc020325a:	00002617          	auipc	a2,0x2
ffffffffc020325e:	b4e60613          	addi	a2,a2,-1202 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203262:	0a600593          	li	a1,166
ffffffffc0203266:	00003517          	auipc	a0,0x3
ffffffffc020326a:	91250513          	addi	a0,a0,-1774 # ffffffffc0205b78 <default_pmm_manager+0xa20>
ffffffffc020326e:	906fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc0203272:	00003697          	auipc	a3,0x3
ffffffffc0203276:	91e68693          	addi	a3,a3,-1762 # ffffffffc0205b90 <default_pmm_manager+0xa38>
ffffffffc020327a:	00002617          	auipc	a2,0x2
ffffffffc020327e:	b2e60613          	addi	a2,a2,-1234 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203282:	0a400593          	li	a1,164
ffffffffc0203286:	00003517          	auipc	a0,0x3
ffffffffc020328a:	8f250513          	addi	a0,a0,-1806 # ffffffffc0205b78 <default_pmm_manager+0xa20>
ffffffffc020328e:	8e6fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc0203292:	00003697          	auipc	a3,0x3
ffffffffc0203296:	8fe68693          	addi	a3,a3,-1794 # ffffffffc0205b90 <default_pmm_manager+0xa38>
ffffffffc020329a:	00002617          	auipc	a2,0x2
ffffffffc020329e:	b0e60613          	addi	a2,a2,-1266 # ffffffffc0204da8 <commands+0x738>
ffffffffc02032a2:	0a200593          	li	a1,162
ffffffffc02032a6:	00003517          	auipc	a0,0x3
ffffffffc02032aa:	8d250513          	addi	a0,a0,-1838 # ffffffffc0205b78 <default_pmm_manager+0xa20>
ffffffffc02032ae:	8c6fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032b2:	00003697          	auipc	a3,0x3
ffffffffc02032b6:	8de68693          	addi	a3,a3,-1826 # ffffffffc0205b90 <default_pmm_manager+0xa38>
ffffffffc02032ba:	00002617          	auipc	a2,0x2
ffffffffc02032be:	aee60613          	addi	a2,a2,-1298 # ffffffffc0204da8 <commands+0x738>
ffffffffc02032c2:	0a000593          	li	a1,160
ffffffffc02032c6:	00003517          	auipc	a0,0x3
ffffffffc02032ca:	8b250513          	addi	a0,a0,-1870 # ffffffffc0205b78 <default_pmm_manager+0xa20>
ffffffffc02032ce:	8a6fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032d2:	00003697          	auipc	a3,0x3
ffffffffc02032d6:	8be68693          	addi	a3,a3,-1858 # ffffffffc0205b90 <default_pmm_manager+0xa38>
ffffffffc02032da:	00002617          	auipc	a2,0x2
ffffffffc02032de:	ace60613          	addi	a2,a2,-1330 # ffffffffc0204da8 <commands+0x738>
ffffffffc02032e2:	09e00593          	li	a1,158
ffffffffc02032e6:	00003517          	auipc	a0,0x3
ffffffffc02032ea:	89250513          	addi	a0,a0,-1902 # ffffffffc0205b78 <default_pmm_manager+0xa20>
ffffffffc02032ee:	886fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032f2:	00003697          	auipc	a3,0x3
ffffffffc02032f6:	89e68693          	addi	a3,a3,-1890 # ffffffffc0205b90 <default_pmm_manager+0xa38>
ffffffffc02032fa:	00002617          	auipc	a2,0x2
ffffffffc02032fe:	aae60613          	addi	a2,a2,-1362 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203302:	09a00593          	li	a1,154
ffffffffc0203306:	00003517          	auipc	a0,0x3
ffffffffc020330a:	87250513          	addi	a0,a0,-1934 # ffffffffc0205b78 <default_pmm_manager+0xa20>
ffffffffc020330e:	866fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc0203312:	00003697          	auipc	a3,0x3
ffffffffc0203316:	87e68693          	addi	a3,a3,-1922 # ffffffffc0205b90 <default_pmm_manager+0xa38>
ffffffffc020331a:	00002617          	auipc	a2,0x2
ffffffffc020331e:	a8e60613          	addi	a2,a2,-1394 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203322:	09800593          	li	a1,152
ffffffffc0203326:	00003517          	auipc	a0,0x3
ffffffffc020332a:	85250513          	addi	a0,a0,-1966 # ffffffffc0205b78 <default_pmm_manager+0xa20>
ffffffffc020332e:	846fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc0203332:	00002697          	auipc	a3,0x2
ffffffffc0203336:	69668693          	addi	a3,a3,1686 # ffffffffc02059c8 <default_pmm_manager+0x870>
ffffffffc020333a:	00002617          	auipc	a2,0x2
ffffffffc020333e:	a6e60613          	addi	a2,a2,-1426 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203342:	09600593          	li	a1,150
ffffffffc0203346:	00003517          	auipc	a0,0x3
ffffffffc020334a:	83250513          	addi	a0,a0,-1998 # ffffffffc0205b78 <default_pmm_manager+0xa20>
ffffffffc020334e:	826fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc0203352:	00002697          	auipc	a3,0x2
ffffffffc0203356:	67668693          	addi	a3,a3,1654 # ffffffffc02059c8 <default_pmm_manager+0x870>
ffffffffc020335a:	00002617          	auipc	a2,0x2
ffffffffc020335e:	a4e60613          	addi	a2,a2,-1458 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203362:	09400593          	li	a1,148
ffffffffc0203366:	00003517          	auipc	a0,0x3
ffffffffc020336a:	81250513          	addi	a0,a0,-2030 # ffffffffc0205b78 <default_pmm_manager+0xa20>
ffffffffc020336e:	806fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc0203372:	00002697          	auipc	a3,0x2
ffffffffc0203376:	65668693          	addi	a3,a3,1622 # ffffffffc02059c8 <default_pmm_manager+0x870>
ffffffffc020337a:	00002617          	auipc	a2,0x2
ffffffffc020337e:	a2e60613          	addi	a2,a2,-1490 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203382:	09200593          	li	a1,146
ffffffffc0203386:	00002517          	auipc	a0,0x2
ffffffffc020338a:	7f250513          	addi	a0,a0,2034 # ffffffffc0205b78 <default_pmm_manager+0xa20>
ffffffffc020338e:	fe7fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203392 <_clock_swap_out_victim>:
     list_entry_t *head=(list_entry_t*) mm->sm_priv;
ffffffffc0203392:	7514                	ld	a3,40(a0)
{
ffffffffc0203394:	1141                	addi	sp,sp,-16
ffffffffc0203396:	e406                	sd	ra,8(sp)
ffffffffc0203398:	e022                	sd	s0,0(sp)
         assert(head != NULL);
ffffffffc020339a:	ceb9                	beqz	a3,ffffffffc02033f8 <_clock_swap_out_victim+0x66>
     assert(in_tick==0);
ffffffffc020339c:	ee35                	bnez	a2,ffffffffc0203418 <_clock_swap_out_victim+0x86>
ffffffffc020339e:	0000e417          	auipc	s0,0xe
ffffffffc02033a2:	1ba40413          	addi	s0,s0,442 # ffffffffc0211558 <curr_ptr>
ffffffffc02033a6:	852e                	mv	a0,a1
ffffffffc02033a8:	600c                	ld	a1,0(s0)
ffffffffc02033aa:	a801                	j	ffffffffc02033ba <_clock_swap_out_victim+0x28>
        if (p->visited == 0) {
ffffffffc02033ac:	fe05b703          	ld	a4,-32(a1) # fe0 <kern_entry-0xffffffffc01ff020>
ffffffffc02033b0:	cf11                	beqz	a4,ffffffffc02033cc <_clock_swap_out_victim+0x3a>
            p->visited = 0;
ffffffffc02033b2:	fe05b023          	sd	zero,-32(a1)
    while (1) {
ffffffffc02033b6:	4605                	li	a2,1
ffffffffc02033b8:	85be                	mv	a1,a5
        if(curr_ptr->next == head)
ffffffffc02033ba:	659c                	ld	a5,8(a1)
ffffffffc02033bc:	fed798e3          	bne	a5,a3,ffffffffc02033ac <_clock_swap_out_victim+0x1a>
            curr_ptr = head->next;
ffffffffc02033c0:	668c                	ld	a1,8(a3)
            curr_ptr=curr_ptr->next;
ffffffffc02033c2:	4605                	li	a2,1
        if (p->visited == 0) {
ffffffffc02033c4:	fe05b703          	ld	a4,-32(a1)
            curr_ptr=curr_ptr->next;
ffffffffc02033c8:	659c                	ld	a5,8(a1)
        if (p->visited == 0) {
ffffffffc02033ca:	f765                	bnez	a4,ffffffffc02033b2 <_clock_swap_out_victim+0x20>
ffffffffc02033cc:	c211                	beqz	a2,ffffffffc02033d0 <_clock_swap_out_victim+0x3e>
ffffffffc02033ce:	e00c                	sd	a1,0(s0)
    __list_del(listelm->prev, listelm->next);
ffffffffc02033d0:	6198                	ld	a4,0(a1)
        struct Page *p = le2page(curr_ptr, pra_page_link);
ffffffffc02033d2:	fd058693          	addi	a3,a1,-48
    prev->next = next;
ffffffffc02033d6:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc02033d8:	e398                	sd	a4,0(a5)
            *ptr_page = p;
ffffffffc02033da:	e114                	sd	a3,0(a0)
            cprintf("curr_ptr 0xffffffff%x\n", curr_ptr);
ffffffffc02033dc:	00003517          	auipc	a0,0x3
ffffffffc02033e0:	81c50513          	addi	a0,a0,-2020 # ffffffffc0205bf8 <default_pmm_manager+0xaa0>
...
ffffffffc02033ec:	4501                	li	a0,0
            curr_ptr=curr_ptr->next;
ffffffffc02033ee:	679c                	ld	a5,8(a5)
ffffffffc02033f0:	e01c                	sd	a5,0(s0)
}
ffffffffc02033f2:	6402                	ld	s0,0(sp)
ffffffffc02033f4:	0141                	addi	sp,sp,16
ffffffffc02033f6:	8082                	ret
         assert(head != NULL);
ffffffffc02033f8:	00002697          	auipc	a3,0x2
ffffffffc02033fc:	7e068693          	addi	a3,a3,2016 # ffffffffc0205bd8 <default_pmm_manager+0xa80>
ffffffffc0203400:	00002617          	auipc	a2,0x2
ffffffffc0203404:	9a860613          	addi	a2,a2,-1624 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203408:	04c00593          	li	a1,76
ffffffffc020340c:	00002517          	auipc	a0,0x2
ffffffffc0203410:	76c50513          	addi	a0,a0,1900 # ffffffffc0205b78 <default_pmm_manager+0xa20>
ffffffffc0203414:	f61fc0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(in_tick==0);
ffffffffc0203418:	00002697          	auipc	a3,0x2
ffffffffc020341c:	7d068693          	addi	a3,a3,2000 # ffffffffc0205be8 <default_pmm_manager+0xa90>
ffffffffc0203420:	00002617          	auipc	a2,0x2
ffffffffc0203424:	98860613          	addi	a2,a2,-1656 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203428:	04d00593          	li	a1,77
ffffffffc020342c:	00002517          	auipc	a0,0x2
ffffffffc0203430:	74c50513          	addi	a0,a0,1868 # ffffffffc0205b78 <default_pmm_manager+0xa20>
ffffffffc0203434:	f41fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203438 <_clock_init_mm>:
{     
ffffffffc0203438:	1141                	addi	sp,sp,-16
ffffffffc020343a:	e406                	sd	ra,8(sp)
    elm->prev = elm->next = elm;
ffffffffc020343c:	0000e597          	auipc	a1,0xe
ffffffffc0203440:	cac58593          	addi	a1,a1,-852 # ffffffffc02110e8 <pra_list_head>
        mm->sm_priv = &pra_list_head;
ffffffffc0203444:	f50c                	sd	a1,40(a0)
     cprintf(" mm->sm_priv %x in fifo_init_mm\n",mm->sm_priv);
ffffffffc0203446:	00002517          	auipc	a0,0x2
ffffffffc020344a:	7ca50513          	addi	a0,a0,1994 # ffffffffc0205c10 <default_pmm_manager+0xab8>
ffffffffc020344e:	e58c                	sd	a1,8(a1)
ffffffffc0203450:	e18c                	sd	a1,0(a1)
        curr_ptr = &pra_list_head;
ffffffffc0203452:	0000e797          	auipc	a5,0xe
ffffffffc0203456:	10b7b323          	sd	a1,262(a5) # ffffffffc0211558 <curr_ptr>
     cprintf(" mm->sm_priv %x in fifo_init_mm\n",mm->sm_priv);
ffffffffc020345a:	c61fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
}
ffffffffc020345e:	60a2                	ld	ra,8(sp)
...
ffffffffc020346a:	0f27b783          	ld	a5,242(a5) # ffffffffc0211558 <curr_ptr>
ffffffffc020346e:	cf81                	beqz	a5,ffffffffc0203486 <_clock_map_swappable+0x20>
    __list_add(elm, listelm->prev, listelm);
ffffffffc0203470:	6394                	ld	a3,0(a5)
ffffffffc0203472:	03060713          	addi	a4,a2,48
    prev->next = next->prev = elm;
ffffffffc0203476:	e398                	sd	a4,0(a5)
ffffffffc0203478:	e698                	sd	a4,8(a3)
    elm->next = next;
ffffffffc020347a:	fe1c                	sd	a5,56(a2)
    page->visited = 1;
ffffffffc020347c:	4785                	li	a5,1
    elm->prev = prev;
ffffffffc020347e:	fa14                	sd	a3,48(a2)
...
ffffffffc020348c:	7b068693          	addi	a3,a3,1968 # ffffffffc0205c38 <default_pmm_manager+0xae0>
ffffffffc0203490:	00002617          	auipc	a2,0x2
ffffffffc0203494:	91860613          	addi	a2,a2,-1768 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203498:	03900593          	li	a1,57
ffffffffc020349c:	00002517          	auipc	a0,0x2
ffffffffc02034a0:	6dc50513          	addi	a0,a0,1756 # ffffffffc0205b78 <default_pmm_manager+0xa20>
{
ffffffffc02034a4:	e406                	sd	ra,8(sp)
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc02034a6:	ecffc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02034aa <check_vma_overlap.part.0>:
}
...
ffffffffc02034aa:	1141                	addi	sp,sp,-16
    assert(prev->vm_start < prev->vm_end);
    assert(prev->vm_end <= next->vm_start);
    assert(next->vm_start < next->vm_end);
ffffffffc02034ac:	00002697          	auipc	a3,0x2
ffffffffc02034b0:	7cc68693          	addi	a3,a3,1996 # ffffffffc0205c78 <default_pmm_manager+0xb20>
ffffffffc02034b4:	00002617          	auipc	a2,0x2
ffffffffc02034b8:	8f460613          	addi	a2,a2,-1804 # ffffffffc0204da8 <commands+0x738>
ffffffffc02034bc:	07d00593          	li	a1,125
ffffffffc02034c0:	00002517          	auipc	a0,0x2
ffffffffc02034c4:	7d850513          	addi	a0,a0,2008 # ffffffffc0205c98 <default_pmm_manager+0xb40>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
ffffffffc02034c8:	e406                	sd	ra,8(sp)
    assert(next->vm_start < next->vm_end);
ffffffffc02034ca:	eabfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02034ce <mm_create>:
mm_create(void) {
ffffffffc02034ce:	1141                	addi	sp,sp,-16
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc02034d0:	03000513          	li	a0,48
mm_create(void) {
ffffffffc02034d4:	e022                	sd	s0,0(sp)
ffffffffc02034d6:	e406                	sd	ra,8(sp)
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc02034d8:	aa0ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02034dc:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc02034de:	c105                	beqz	a0,ffffffffc02034fe <mm_create+0x30>
    elm->prev = elm->next = elm;
ffffffffc02034e0:	e408                	sd	a0,8(s0)
ffffffffc02034e2:	e008                	sd	a0,0(s0)
        mm->mmap_cache = NULL;
ffffffffc02034e4:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc02034e8:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc02034ec:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02034f0:	0000e797          	auipc	a5,0xe
ffffffffc02034f4:	0607a783          	lw	a5,96(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc02034f8:	eb81                	bnez	a5,ffffffffc0203508 <mm_create+0x3a>
        else mm->sm_priv = NULL;
ffffffffc02034fa:	02053423          	sd	zero,40(a0)
}
ffffffffc02034fe:	60a2                	ld	ra,8(sp)
ffffffffc0203500:	8522                	mv	a0,s0
ffffffffc0203502:	6402                	ld	s0,0(sp)
ffffffffc0203504:	0141                	addi	sp,sp,16
ffffffffc0203506:	8082                	ret
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203508:	a7dff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
}
ffffffffc020350c:	60a2                	ld	ra,8(sp)
ffffffffc020350e:	8522                	mv	a0,s0
ffffffffc0203510:	6402                	ld	s0,0(sp)
ffffffffc0203512:	0141                	addi	sp,sp,16
ffffffffc0203514:	8082                	ret

ffffffffc0203516 <vma_create>:
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc0203516:	1101                	addi	sp,sp,-32
ffffffffc0203518:	e04a                	sd	s2,0(sp)
ffffffffc020351a:	892a                	mv	s2,a0
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc020351c:	03000513          	li	a0,48
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc0203520:	e822                	sd	s0,16(sp)
ffffffffc0203522:	e426                	sd	s1,8(sp)
ffffffffc0203524:	ec06                	sd	ra,24(sp)
ffffffffc0203526:	84ae                	mv	s1,a1
ffffffffc0203528:	8432                	mv	s0,a2
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc020352a:	a4eff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (vma != NULL) {
ffffffffc020352e:	c509                	beqz	a0,ffffffffc0203538 <vma_create+0x22>
        vma->vm_start = vm_start;
ffffffffc0203530:	01253423          	sd	s2,8(a0)
        vma->vm_end = vm_end;
ffffffffc0203534:	e904                	sd	s1,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc0203536:	ed00                	sd	s0,24(a0)
}
ffffffffc0203538:	60e2                	ld	ra,24(sp)
ffffffffc020353a:	6442                	ld	s0,16(sp)
ffffffffc020353c:	64a2                	ld	s1,8(sp)
ffffffffc020353e:	6902                	ld	s2,0(sp)
ffffffffc0203540:	6105                	addi	sp,sp,32
ffffffffc0203542:	8082                	ret

ffffffffc0203544 <find_vma>:
find_vma(struct mm_struct *mm, uintptr_t addr) {
ffffffffc0203544:	86aa                	mv	a3,a0
    if (mm != NULL) {
ffffffffc0203546:	c505                	beqz	a0,ffffffffc020356e <find_vma+0x2a>
        vma = mm->mmap_cache;
ffffffffc0203548:	6908                	ld	a0,16(a0)
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc020354a:	c501                	beqz	a0,ffffffffc0203552 <find_vma+0xe>
ffffffffc020354c:	651c                	ld	a5,8(a0)
ffffffffc020354e:	02f5f263          	bgeu	a1,a5,ffffffffc0203572 <find_vma+0x2e>
    return listelm->next;
ffffffffc0203552:	669c                	ld	a5,8(a3)
                while ((le = list_next(le)) != list) {
ffffffffc0203554:	00f68d63          	beq	a3,a5,ffffffffc020356e <find_vma+0x2a>
                    if (vma->vm_start<=addr && addr < vma->vm_end) {
ffffffffc0203558:	fe87b703          	ld	a4,-24(a5)
ffffffffc020355c:	00e5e663          	bltu	a1,a4,ffffffffc0203568 <find_vma+0x24>
ffffffffc0203560:	ff07b703          	ld	a4,-16(a5)
ffffffffc0203564:	00e5ec63          	bltu	a1,a4,ffffffffc020357c <find_vma+0x38>
ffffffffc0203568:	679c                	ld	a5,8(a5)
                while ((le = list_next(le)) != list) {
ffffffffc020356a:	fef697e3          	bne	a3,a5,ffffffffc0203558 <find_vma+0x14>
    struct vma_struct *vma = NULL;
ffffffffc020356e:	4501                	li	a0,0
}
ffffffffc0203570:	8082                	ret
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc0203572:	691c                	ld	a5,16(a0)
ffffffffc0203574:	fcf5ffe3          	bgeu	a1,a5,ffffffffc0203552 <find_vma+0xe>
            mm->mmap_cache = vma;
ffffffffc0203578:	ea88                	sd	a0,16(a3)
ffffffffc020357a:	8082                	ret
                    vma = le2vma(le, list_link);
ffffffffc020357c:	fe078513          	addi	a0,a5,-32
            mm->mmap_cache = vma;
ffffffffc0203580:	ea88                	sd	a0,16(a3)
ffffffffc0203582:	8082                	ret

ffffffffc0203584 <insert_vma_struct>:
...
ffffffffc0203584:	6590                	ld	a2,8(a1)
ffffffffc0203586:	0105b803          	ld	a6,16(a1)
insert_vma_struct(struct mm_struct *mm, struct vma_struct *vma) {
ffffffffc020358a:	1141                	addi	sp,sp,-16
ffffffffc020358c:	e406                	sd	ra,8(sp)
ffffffffc020358e:	87aa                	mv	a5,a0
    assert(vma->vm_start < vma->vm_end);
ffffffffc0203590:	01066763          	bltu	a2,a6,ffffffffc020359e <insert_vma_struct+0x1a>
ffffffffc0203594:	a085                	j	ffffffffc02035f4 <insert_vma_struct+0x70>
...
ffffffffc020359a:	04e66863          	bltu	a2,a4,ffffffffc02035ea <insert_vma_struct+0x66>
ffffffffc020359e:	86be                	mv	a3,a5
ffffffffc02035a0:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc02035a2:	fef51ae3          	bne	a0,a5,ffffffffc0203596 <insert_vma_struct+0x12>
        }
    ...
    /* check overlap */
    if (le_prev != list) {
ffffffffc02035a6:	02a68463          	beq	a3,a0,ffffffffc02035ce <insert_vma_struct+0x4a>
        check_vma_overlap(le2vma(le_prev, list_link), vma);
ffffffffc02035aa:	ff06b703          	ld	a4,-16(a3)
    assert(prev->vm_start < prev->vm_end);
ffffffffc02035ae:	fe86b883          	ld	a7,-24(a3)
ffffffffc02035b2:	08e8f163          	bgeu	a7,a4,ffffffffc0203634 <insert_vma_struct+0xb0>
    assert(prev->vm_end <= next->vm_start);
ffffffffc02035b6:	04e66f63          	bltu	a2,a4,ffffffffc0203614 <insert_vma_struct+0x90>
    }
    if (le_next != list) {
ffffffffc02035ba:	00f50a63          	beq	a0,a5,ffffffffc02035ce <insert_vma_struct+0x4a>
            if (mmap_prev->vm_start > vma->vm_start) {
ffffffffc02035be:	fe87b703          	ld	a4,-24(a5)
    assert(prev->vm_end <= next->vm_start);
ffffffffc02035c2:	05076963          	bltu	a4,a6,ffffffffc0203614 <insert_vma_struct+0x90>
    assert(next->vm_start < next->vm_end);
ffffffffc02035c6:	ff07b603          	ld	a2,-16(a5)
ffffffffc02035ca:	02c77363          	bgeu	a4,a2,ffffffffc02035f0 <insert_vma_struct+0x6c>
    }
    ...
    mm->map_count ++;
ffffffffc02035ce:	5118                	lw	a4,32(a0)
    vma->vm_mm = mm;
ffffffffc02035d0:	e188                	sd	a0,0(a1)
    list_add_after(le_prev, &(vma->list_link));
ffffffffc02035d2:	02058613          	addi	a2,a1,32
    prev->next = next->prev = elm;
ffffffffc02035d6:	e390                	sd	a2,0(a5)
ffffffffc02035d8:	e690                	sd	a2,8(a3)
}
ffffffffc02035da:	60a2                	ld	ra,8(sp)
    elm->next = next;
ffffffffc02035dc:	f59c                	sd	a5,40(a1)
    elm->prev = prev;
ffffffffc02035de:	f194                	sd	a3,32(a1)
    mm->map_count ++;
ffffffffc02035e0:	0017079b          	addiw	a5,a4,1
ffffffffc02035e4:	d11c                	sw	a5,32(a0)
}
ffffffffc02035e6:	0141                	addi	sp,sp,16
ffffffffc02035e8:	8082                	ret
    if (le_prev != list) {
ffffffffc02035ea:	fca690e3          	bne	a3,a0,ffffffffc02035aa <insert_vma_struct+0x26>
ffffffffc02035ee:	bfd1                	j	ffffffffc02035c2 <insert_vma_struct+0x3e>
ffffffffc02035f0:	ebbff0ef          	jal	ra,ffffffffc02034aa <check_vma_overlap.part.0>
    assert(vma->vm_start < vma->vm_end);
ffffffffc02035f4:	00002697          	auipc	a3,0x2
ffffffffc02035f8:	6b468693          	addi	a3,a3,1716 # ffffffffc0205ca8 <default_pmm_manager+0xb50>
ffffffffc02035fc:	00001617          	auipc	a2,0x1
ffffffffc0203600:	7ac60613          	addi	a2,a2,1964 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203604:	08400593          	li	a1,132
ffffffffc0203608:	00002517          	auipc	a0,0x2
ffffffffc020360c:	69050513          	addi	a0,a0,1680 # ffffffffc0205c98 <default_pmm_manager+0xb40>
ffffffffc0203610:	d65fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc0203614:	00002697          	auipc	a3,0x2
ffffffffc0203618:	6d468693          	addi	a3,a3,1748 # ffffffffc0205ce8 <default_pmm_manager+0xb90>
ffffffffc020361c:	00001617          	auipc	a2,0x1
ffffffffc0203620:	78c60613          	addi	a2,a2,1932 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203624:	07c00593          	li	a1,124
ffffffffc0203628:	00002517          	auipc	a0,0x2
ffffffffc020362c:	67050513          	addi	a0,a0,1648 # ffffffffc0205c98 <default_pmm_manager+0xb40>
ffffffffc0203630:	d45fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc0203634:	00002697          	auipc	a3,0x2
ffffffffc0203638:	69468693          	addi	a3,a3,1684 # ffffffffc0205cc8 <default_pmm_manager+0xb70>
ffffffffc020363c:	00001617          	auipc	a2,0x1
ffffffffc0203640:	76c60613          	addi	a2,a2,1900 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203644:	07b00593          	li	a1,123
ffffffffc0203648:	00002517          	auipc	a0,0x2
ffffffffc020364c:	65050513          	addi	a0,a0,1616 # ffffffffc0205c98 <default_pmm_manager+0xb40>
ffffffffc0203650:	d25fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203654 <mm_destroy>:

// mm_destroy - free mm and mm internal fields
void
mm_destroy(struct mm_struct *mm) {
ffffffffc0203654:	1141                	addi	sp,sp,-16
ffffffffc0203656:	e022                	sd	s0,0(sp)
ffffffffc0203658:	842a                	mv	s0,a0
    return listelm->next;
ffffffffc020365a:	6508                	ld	a0,8(a0)
ffffffffc020365c:	e406                	sd	ra,8(sp)

    list_entry_t *list = &(mm->mmap_list), *le;
    while ((le = list_next(list)) != list) {
ffffffffc020365e:	00a40e63          	beq	s0,a0,ffffffffc020367a <mm_destroy+0x26>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203662:	6118                	ld	a4,0(a0)
ffffffffc0203664:	651c                	ld	a5,8(a0)
        list_del(le);
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc0203666:	03000593          	li	a1,48
ffffffffc020366a:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc020366c:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc020366e:	e398                	sd	a4,0(a5)
ffffffffc0203670:	9c2ff0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc0203674:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203676:	fea416e3          	bne	s0,a0,ffffffffc0203662 <mm_destroy+0xe>
    }
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc020367a:	8522                	mv	a0,s0
    mm=NULL;
}
ffffffffc020367c:	6402                	ld	s0,0(sp)
...
ffffffffc0203684:	0141                	addi	sp,sp,16
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203686:	9acff06f          	j	ffffffffc0202832 <kfree>

ffffffffc020368a <vmm_init>:

// vmm_init - initialize virtual memory management
//          - now just call check_vmm to check correctness of vmm
void
vmm_init(void) {
ffffffffc020368a:	715d                	addi	sp,sp,-80
ffffffffc020368c:	e486                	sd	ra,72(sp)
ffffffffc020368e:	f44e                	sd	s3,40(sp)
ffffffffc0203690:	f052                	sd	s4,32(sp)
ffffffffc0203692:	e0a2                	sd	s0,64(sp)
ffffffffc0203694:	fc26                	sd	s1,56(sp)
ffffffffc0203696:	f84a                	sd	s2,48(sp)
ffffffffc0203698:	ec56                	sd	s5,24(sp)
ffffffffc020369a:	e85a                	sd	s6,16(sp)
ffffffffc020369c:	e45e                	sd	s7,8(sp)
}
...
ffffffffc020369e:	ff5fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc02036a2:	89aa                	mv	s3,a0
...
ffffffffc02036a8:	8a2a                	mv	s4,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc02036aa:	03000513          	li	a0,48
ffffffffc02036ae:	8caff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (mm != NULL) {
ffffffffc02036b2:	56050863          	beqz	a0,ffffffffc0203c22 <vmm_init+0x598>
    elm->prev = elm->next = elm;
...
ffffffffc02036ca:	e8a7a783          	lw	a5,-374(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc02036ce:	84aa                	mv	s1,a0
ffffffffc02036d0:	e7b9                	bnez	a5,ffffffffc020371e <vmm_init+0x94>
        else mm->sm_priv = NULL;
ffffffffc02036d2:	02053423          	sd	zero,40(a0)
vmm_init(void) {
ffffffffc02036d6:	03200413          	li	s0,50
ffffffffc02036da:	a811                	j	ffffffffc02036ee <vmm_init+0x64>
        vma->vm_start = vm_start;
...
ffffffffc02036e0:	00053c23          	sd	zero,24(a0)
    ...
    int i;
    for (i = step1; i >= 1; i --) {
ffffffffc02036e4:	146d                	addi	s0,s0,-5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc02036e6:	8526                	mv	a0,s1
ffffffffc02036e8:	e9dff0ef          	jal	ra,ffffffffc0203584 <insert_vma_struct>
    for (i = step1; i >= 1; i --) {
ffffffffc02036ec:	cc05                	beqz	s0,ffffffffc0203724 <vmm_init+0x9a>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02036ee:	03000513          	li	a0,48
ffffffffc02036f2:	886ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02036f6:	85aa                	mv	a1,a0
ffffffffc02036f8:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc02036fc:	f165                	bnez	a0,ffffffffc02036dc <vmm_init+0x52>
        assert(vma != NULL);
ffffffffc02036fe:	00002697          	auipc	a3,0x2
ffffffffc0203702:	18a68693          	addi	a3,a3,394 # ffffffffc0205888 <default_pmm_manager+0x730>
ffffffffc0203706:	00001617          	auipc	a2,0x1
ffffffffc020370a:	6a260613          	addi	a2,a2,1698 # ffffffffc0204da8 <commands+0x738>
ffffffffc020370e:	0ce00593          	li	a1,206
ffffffffc0203712:	00002517          	auipc	a0,0x2
ffffffffc0203716:	58650513          	addi	a0,a0,1414 # ffffffffc0205c98 <default_pmm_manager+0xb40>
ffffffffc020371a:	c5bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc020371e:	867ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc0203722:	bf55                	j	ffffffffc02036d6 <vmm_init+0x4c>
ffffffffc0203724:	03700413          	li	s0,55
    }

    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203728:	1f900913          	li	s2,505
ffffffffc020372c:	a819                	j	ffffffffc0203742 <vmm_init+0xb8>
        vma->vm_start = vm_start;
ffffffffc020372e:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
ffffffffc0203730:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc0203732:	00053c23          	sd	zero,24(a0)
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203736:	0415                	addi	s0,s0,5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc0203738:	8526                	mv	a0,s1
ffffffffc020373a:	e4bff0ef          	jal	ra,ffffffffc0203584 <insert_vma_struct>
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc020373e:	03240a63          	beq	s0,s2,ffffffffc0203772 <vmm_init+0xe8>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203742:	03000513          	li	a0,48
ffffffffc0203746:	832ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc020374a:	85aa                	mv	a1,a0
ffffffffc020374c:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc0203750:	fd79                	bnez	a0,ffffffffc020372e <vmm_init+0xa4>
        assert(vma != NULL);
ffffffffc0203752:	00002697          	auipc	a3,0x2
ffffffffc0203756:	13668693          	addi	a3,a3,310 # ffffffffc0205888 <default_pmm_manager+0x730>
ffffffffc020375a:	00001617          	auipc	a2,0x1
ffffffffc020375e:	64e60613          	addi	a2,a2,1614 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203762:	0d400593          	li	a1,212
ffffffffc0203766:	00002517          	auipc	a0,0x2
ffffffffc020376a:	53250513          	addi	a0,a0,1330 # ffffffffc0205c98 <default_pmm_manager+0xb40>
ffffffffc020376e:	c07fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    return listelm->next;
ffffffffc0203772:	649c                	ld	a5,8(s1)
ffffffffc0203774:	471d                	li	a4,7
    }

    list_entry_t *le = list_next(&(mm->mmap_list));

    for (i = 1; i <= step2; i ++) {
ffffffffc0203776:	1fb00593          	li	a1,507
        assert(le != &(mm->mmap_list));
ffffffffc020377a:	2ef48463          	beq	s1,a5,ffffffffc0203a62 <vmm_init+0x3d8>
        struct vma_struct *mmap = le2vma(le, list_link);
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc020377e:	fe87b603          	ld	a2,-24(a5)
ffffffffc0203782:	ffe70693          	addi	a3,a4,-2
ffffffffc0203786:	26d61e63          	bne	a2,a3,ffffffffc0203a02 <vmm_init+0x378>
ffffffffc020378a:	ff07b683          	ld	a3,-16(a5)
ffffffffc020378e:	26e69a63          	bne	a3,a4,ffffffffc0203a02 <vmm_init+0x378>
    for (i = 1; i <= step2; i ++) {
ffffffffc0203792:	0715                	addi	a4,a4,5
ffffffffc0203794:	679c                	ld	a5,8(a5)
ffffffffc0203796:	feb712e3          	bne	a4,a1,ffffffffc020377a <vmm_init+0xf0>
ffffffffc020379a:	4b1d                	li	s6,7
ffffffffc020379c:	4415                	li	s0,5
        le = list_next(le);
    }

    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc020379e:	1f900b93          	li	s7,505
        struct vma_struct *vma1 = find_vma(mm, i);
ffffffffc02037a2:	85a2                	mv	a1,s0
ffffffffc02037a4:	8526                	mv	a0,s1
ffffffffc02037a6:	d9fff0ef          	jal	ra,ffffffffc0203544 <find_vma>
ffffffffc02037aa:	892a                	mv	s2,a0
        assert(vma1 != NULL);
ffffffffc02037ac:	2c050b63          	beqz	a0,ffffffffc0203a82 <vmm_init+0x3f8>
        struct vma_struct *vma2 = find_vma(mm, i+1);
ffffffffc02037b0:	00140593          	addi	a1,s0,1
ffffffffc02037b4:	8526                	mv	a0,s1
ffffffffc02037b6:	d8fff0ef          	jal	ra,ffffffffc0203544 <find_vma>
ffffffffc02037ba:	8aaa                	mv	s5,a0
        assert(vma2 != NULL);
ffffffffc02037bc:	2e050363          	beqz	a0,ffffffffc0203aa2 <vmm_init+0x418>
        struct vma_struct *vma3 = find_vma(mm, i+2);
ffffffffc02037c0:	85da                	mv	a1,s6
ffffffffc02037c2:	8526                	mv	a0,s1
ffffffffc02037c4:	d81ff0ef          	jal	ra,ffffffffc0203544 <find_vma>
        assert(vma3 == NULL);
ffffffffc02037c8:	2e051d63          	bnez	a0,ffffffffc0203ac2 <vmm_init+0x438>
        struct vma_struct *vma4 = find_vma(mm, i+3);
ffffffffc02037cc:	00340593          	addi	a1,s0,3
ffffffffc02037d0:	8526                	mv	a0,s1
ffffffffc02037d2:	d73ff0ef          	jal	ra,ffffffffc0203544 <find_vma>
        assert(vma4 == NULL);
ffffffffc02037d6:	30051663          	bnez	a0,ffffffffc0203ae2 <vmm_init+0x458>
        struct vma_struct *vma5 = find_vma(mm, i+4);
ffffffffc02037da:	00440593          	addi	a1,s0,4
ffffffffc02037de:	8526                	mv	a0,s1
ffffffffc02037e0:	d65ff0ef          	jal	ra,ffffffffc0203544 <find_vma>
        assert(vma5 == NULL);
ffffffffc02037e4:	30051f63          	bnez	a0,ffffffffc0203b02 <vmm_init+0x478>

        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc02037e8:	00893783          	ld	a5,8(s2)
ffffffffc02037ec:	24879b63          	bne	a5,s0,ffffffffc0203a42 <vmm_init+0x3b8>
ffffffffc02037f0:	01093783          	ld	a5,16(s2)
ffffffffc02037f4:	25679763          	bne	a5,s6,ffffffffc0203a42 <vmm_init+0x3b8>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc02037f8:	008ab783          	ld	a5,8(s5)
ffffffffc02037fc:	22879363          	bne	a5,s0,ffffffffc0203a22 <vmm_init+0x398>
ffffffffc0203800:	010ab783          	ld	a5,16(s5)
ffffffffc0203804:	21679f63          	bne	a5,s6,ffffffffc0203a22 <vmm_init+0x398>
    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc0203808:	0415                	addi	s0,s0,5
ffffffffc020380a:	0b15                	addi	s6,s6,5
ffffffffc020380c:	f9741be3          	bne	s0,s7,ffffffffc02037a2 <vmm_init+0x118>
ffffffffc0203810:	4411                	li	s0,4
    }

    for (i =4; i>=0; i--) {
ffffffffc0203812:	597d                	li	s2,-1
        struct vma_struct *vma_below_5= find_vma(mm,i);
ffffffffc0203814:	85a2                	mv	a1,s0
ffffffffc0203816:	8526                	mv	a0,s1
ffffffffc0203818:	d2dff0ef          	jal	ra,ffffffffc0203544 <find_vma>
ffffffffc020381c:	0004059b          	sext.w	a1,s0
        if (vma_below_5 != NULL ) {
ffffffffc0203820:	c90d                	beqz	a0,ffffffffc0203852 <vmm_init+0x1c8>
           cprintf("vma_below_5: i %x, start %x, end %x\n",i, vma_below_5->vm_start, vma_below_5->vm_end); 
ffffffffc0203822:	6914                	ld	a3,16(a0)
ffffffffc0203824:	6510                	ld	a2,8(a0)
ffffffffc0203826:	00002517          	auipc	a0,0x2
ffffffffc020382a:	5e250513          	addi	a0,a0,1506 # ffffffffc0205e08 <default_pmm_manager+0xcb0>
ffffffffc020382e:	88dfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203832:	00002697          	auipc	a3,0x2
ffffffffc0203836:	5fe68693          	addi	a3,a3,1534 # ffffffffc0205e30 <default_pmm_manager+0xcd8>
ffffffffc020383a:	00001617          	auipc	a2,0x1
ffffffffc020383e:	56e60613          	addi	a2,a2,1390 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203842:	0f600593          	li	a1,246
ffffffffc0203846:	00002517          	auipc	a0,0x2
ffffffffc020384a:	45250513          	addi	a0,a0,1106 # ffffffffc0205c98 <default_pmm_manager+0xb40>
ffffffffc020384e:	b27fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    for (i =4; i>=0; i--) {
ffffffffc0203852:	147d                	addi	s0,s0,-1
ffffffffc0203854:	fd2410e3          	bne	s0,s2,ffffffffc0203814 <vmm_init+0x18a>
ffffffffc0203858:	a811                	j	ffffffffc020386c <vmm_init+0x1e2>
    __list_del(listelm->prev, listelm->next);
ffffffffc020385a:	6118                	ld	a4,0(a0)
ffffffffc020385c:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc020385e:	03000593          	li	a1,48
ffffffffc0203862:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc0203864:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203866:	e398                	sd	a4,0(a5)
ffffffffc0203868:	fcbfe0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc020386c:	6488                	ld	a0,8(s1)
    while ((le = list_next(list)) != list) {
ffffffffc020386e:	fea496e3          	bne	s1,a0,ffffffffc020385a <vmm_init+0x1d0>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203872:	03000593          	li	a1,48
ffffffffc0203876:	8526                	mv	a0,s1
ffffffffc0203878:	fbbfe0ef          	jal	ra,ffffffffc0202832 <kfree>
    }
...
ffffffffc0203880:	3caa1163          	bne	s4,a0,ffffffffc0203c42 <vmm_init+0x5b8>

    cprintf("check_vma_struct() succeeded!\n");
ffffffffc0203884:	00002517          	auipc	a0,0x2
ffffffffc0203888:	5ec50513          	addi	a0,a0,1516 # ffffffffc0205e70 <default_pmm_manager+0xd18>
...
check_pgfault(void) {
    ...
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc0203890:	e03fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc0203894:	84aa                	mv	s1,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203896:	03000513          	li	a0,48
ffffffffc020389a:	edffe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc020389e:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc02038a0:	2a050163          	beqz	a0,ffffffffc0203b42 <vmm_init+0x4b8>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02038a4:	0000e797          	auipc	a5,0xe
ffffffffc02038a8:	cac7a783          	lw	a5,-852(a5) # ffffffffc0211550 <swap_init_ok>
    elm->prev = elm->next = elm;
ffffffffc02038ac:	e508                	sd	a0,8(a0)
ffffffffc02038ae:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc02038b0:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc02038b4:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc02038b8:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02038bc:	14079063          	bnez	a5,ffffffffc02039fc <vmm_init+0x372>
        else mm->sm_priv = NULL;
ffffffffc02038c0:	02053423          	sd	zero,40(a0)
    ...
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc02038c4:	0000e917          	auipc	s2,0xe
ffffffffc02038c8:	c5493903          	ld	s2,-940(s2) # ffffffffc0211518 <boot_pgdir>
    assert(pgdir[0] == 0);
ffffffffc02038cc:	00093783          	ld	a5,0(s2)
    check_mm_struct = mm_create();
ffffffffc02038d0:	0000e717          	auipc	a4,0xe
ffffffffc02038d4:	c8873823          	sd	s0,-880(a4) # ffffffffc0211560 <check_mm_struct>
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc02038d8:	01243c23          	sd	s2,24(s0)
    assert(pgdir[0] == 0);
ffffffffc02038dc:	24079363          	bnez	a5,ffffffffc0203b22 <vmm_init+0x498>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02038e0:	03000513          	li	a0,48
ffffffffc02038e4:	e95fe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02038e8:	8a2a                	mv	s4,a0
    if (vma != NULL) {
ffffffffc02038ea:	28050063          	beqz	a0,ffffffffc0203b6a <vmm_init+0x4e0>
        vma->vm_end = vm_end;
ffffffffc02038ee:	002007b7          	lui	a5,0x200
ffffffffc02038f2:	00fa3823          	sd	a5,16(s4)
        vma->vm_flags = vm_flags;
ffffffffc02038f6:	4789                	li	a5,2
    ...
    insert_vma_struct(mm, vma);
ffffffffc02038f8:	85aa                	mv	a1,a0
        vma->vm_flags = vm_flags;
ffffffffc02038fa:	00fa3c23          	sd	a5,24(s4)
    insert_vma_struct(mm, vma);
ffffffffc02038fe:	8522                	mv	a0,s0
        vma->vm_start = vm_start;
ffffffffc0203900:	000a3423          	sd	zero,8(s4)
    insert_vma_struct(mm, vma);
ffffffffc0203904:	c81ff0ef          	jal	ra,ffffffffc0203584 <insert_vma_struct>

    uintptr_t addr = 0x100;
    assert(find_vma(mm, addr) == vma);
ffffffffc0203908:	10000593          	li	a1,256
ffffffffc020390c:	8522                	mv	a0,s0
ffffffffc020390e:	c37ff0ef          	jal	ra,ffffffffc0203544 <find_vma>
ffffffffc0203912:	10000793          	li	a5,256

    int i, sum = 0;
    for (i = 0; i < 100; i ++) {
ffffffffc0203916:	16400713          	li	a4,356
    assert(find_vma(mm, addr) == vma);
ffffffffc020391a:	26aa1863          	bne	s4,a0,ffffffffc0203b8a <vmm_init+0x500>
        *(char *)(addr + i) = i;
ffffffffc020391e:	00f78023          	sb	a5,0(a5) # 200000 <kern_entry-0xffffffffc0000000>
    for (i = 0; i < 100; i ++) {
ffffffffc0203922:	0785                	addi	a5,a5,1
ffffffffc0203924:	fee79de3          	bne	a5,a4,ffffffffc020391e <vmm_init+0x294>
        sum += i;
ffffffffc0203928:	6705                	lui	a4,0x1
ffffffffc020392a:	10000793          	li	a5,256
ffffffffc020392e:	35670713          	addi	a4,a4,854 # 1356 <kern_entry-0xffffffffc01fecaa>
    }
    for (i = 0; i < 100; i ++) {
ffffffffc0203932:	16400613          	li	a2,356
        sum -= *(char *)(addr + i);
ffffffffc0203936:	0007c683          	lbu	a3,0(a5)
    for (i = 0; i < 100; i ++) {
ffffffffc020393a:	0785                	addi	a5,a5,1
        sum -= *(char *)(addr + i);
ffffffffc020393c:	9f15                	subw	a4,a4,a3
    for (i = 0; i < 100; i ++) {
ffffffffc020393e:	fec79ce3          	bne	a5,a2,ffffffffc0203936 <vmm_init+0x2ac>
    }
    assert(sum == 0);
ffffffffc0203942:	26071463          	bnez	a4,ffffffffc0203baa <vmm_init+0x520>

    page_remove(pgdir, ROUNDDOWN(addr, PGSIZE));
ffffffffc0203946:	4581                	li	a1,0
ffffffffc0203948:	854a                	mv	a0,s2
ffffffffc020394a:	fd3fd0ef          	jal	ra,ffffffffc020191c <page_remove>
    return pa2page(PDE_ADDR(pde));
ffffffffc020394e:	00093783          	ld	a5,0(s2)
    if (PPN(pa) >= npage) {
ffffffffc0203952:	0000e717          	auipc	a4,0xe
ffffffffc0203956:	bce73703          	ld	a4,-1074(a4) # ffffffffc0211520 <npage>
    return pa2page(PDE_ADDR(pde));
ffffffffc020395a:	078a                	slli	a5,a5,0x2
ffffffffc020395c:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc020395e:	26e7f663          	bgeu	a5,a4,ffffffffc0203bca <vmm_init+0x540>
    return &pages[PPN(pa) - nbase];
ffffffffc0203962:	00003717          	auipc	a4,0x3
ffffffffc0203966:	91673703          	ld	a4,-1770(a4) # ffffffffc0206278 <nbase>
ffffffffc020396a:	8f99                	sub	a5,a5,a4
ffffffffc020396c:	00379713          	slli	a4,a5,0x3
ffffffffc0203970:	97ba                	add	a5,a5,a4
ffffffffc0203972:	078e                	slli	a5,a5,0x3

    free_page(pde2page(pgdir[0]));
ffffffffc0203974:	0000e517          	auipc	a0,0xe
ffffffffc0203978:	bb453503          	ld	a0,-1100(a0) # ffffffffc0211528 <pages>
ffffffffc020397c:	953e                	add	a0,a0,a5
ffffffffc020397e:	4585                	li	a1,1
ffffffffc0203980:	cd3fd0ef          	jal	ra,ffffffffc0201652 <free_pages>
    return listelm->next;
ffffffffc0203984:	6408                	ld	a0,8(s0)

    pgdir[0] = 0;
ffffffffc0203986:	00093023          	sd	zero,0(s2)

    mm->pgdir = NULL;
ffffffffc020398a:	00043c23          	sd	zero,24(s0)
    while ((le = list_next(list)) != list) {
ffffffffc020398e:	00a40e63          	beq	s0,a0,ffffffffc02039aa <vmm_init+0x320>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203992:	6118                	ld	a4,0(a0)
ffffffffc0203994:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc0203996:	03000593          	li	a1,48
ffffffffc020399a:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc020399c:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc020399e:	e398                	sd	a4,0(a5)
ffffffffc02039a0:	e93fe0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc02039a4:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc02039a6:	fea416e3          	bne	s0,a0,ffffffffc0203992 <vmm_init+0x308>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc02039aa:	03000593          	li	a1,48
ffffffffc02039ae:	8522                	mv	a0,s0
ffffffffc02039b0:	e83fe0ef          	jal	ra,ffffffffc0202832 <kfree>
    mm_destroy(mm);

    check_mm_struct = NULL;
    nr_free_pages_store--;	// szx : Sv39第二级页表多占了一个内存页，所以执行此操作
ffffffffc02039b4:	14fd                	addi	s1,s1,-1
    check_mm_struct = NULL;
ffffffffc02039b6:	0000e797          	auipc	a5,0xe
ffffffffc02039ba:	ba07b523          	sd	zero,-1110(a5) # ffffffffc0211560 <check_mm_struct>

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc02039be:	cd5fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc02039c2:	22a49063          	bne	s1,a0,ffffffffc0203be2 <vmm_init+0x558>

    cprintf("check_pgfault() succeeded!\n");
ffffffffc02039c6:	00002517          	auipc	a0,0x2
ffffffffc02039ca:	4fa50513          	addi	a0,a0,1274 # ffffffffc0205ec0 <default_pmm_manager+0xd68>
ffffffffc02039ce:	eecfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc02039d2:	cc1fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
    nr_free_pages_store--;	// szx : Sv39三级页表多占一个内存页，所以执行此操作
ffffffffc02039d6:	19fd                	addi	s3,s3,-1
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc02039d8:	22a99563          	bne	s3,a0,ffffffffc0203c02 <vmm_init+0x578>
}
ffffffffc02039dc:	6406                	ld	s0,64(sp)
ffffffffc02039de:	60a6                	ld	ra,72(sp)
ffffffffc02039e0:	74e2                	ld	s1,56(sp)
ffffffffc02039e2:	7942                	ld	s2,48(sp)
ffffffffc02039e4:	79a2                	ld	s3,40(sp)
ffffffffc02039e6:	7a02                	ld	s4,32(sp)
ffffffffc02039e8:	6ae2                	ld	s5,24(sp)
ffffffffc02039ea:	6b42                	ld	s6,16(sp)
ffffffffc02039ec:	6ba2                	ld	s7,8(sp)
    cprintf("check_vmm() succeeded.\n");
ffffffffc02039ee:	00002517          	auipc	a0,0x2
ffffffffc02039f2:	4f250513          	addi	a0,a0,1266 # ffffffffc0205ee0 <default_pmm_manager+0xd88>
}
ffffffffc02039f6:	6161                	addi	sp,sp,80
    cprintf("check_vmm() succeeded.\n");
ffffffffc02039f8:	ec2fc06f          	j	ffffffffc02000ba <cprintf>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02039fc:	d88ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc0203a00:	b5d1                	j	ffffffffc02038c4 <vmm_init+0x23a>
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203a02:	00002697          	auipc	a3,0x2
ffffffffc0203a06:	31e68693          	addi	a3,a3,798 # ffffffffc0205d20 <default_pmm_manager+0xbc8>
ffffffffc0203a0a:	00001617          	auipc	a2,0x1
ffffffffc0203a0e:	39e60613          	addi	a2,a2,926 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203a12:	0dd00593          	li	a1,221
ffffffffc0203a16:	00002517          	auipc	a0,0x2
ffffffffc0203a1a:	28250513          	addi	a0,a0,642 # ffffffffc0205c98 <default_pmm_manager+0xb40>
ffffffffc0203a1e:	957fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203a22:	00002697          	auipc	a3,0x2
ffffffffc0203a26:	3b668693          	addi	a3,a3,950 # ffffffffc0205dd8 <default_pmm_manager+0xc80>
ffffffffc0203a2a:	00001617          	auipc	a2,0x1
ffffffffc0203a2e:	37e60613          	addi	a2,a2,894 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203a32:	0ee00593          	li	a1,238
ffffffffc0203a36:	00002517          	auipc	a0,0x2
ffffffffc0203a3a:	26250513          	addi	a0,a0,610 # ffffffffc0205c98 <default_pmm_manager+0xb40>
ffffffffc0203a3e:	937fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203a42:	00002697          	auipc	a3,0x2
ffffffffc0203a46:	36668693          	addi	a3,a3,870 # ffffffffc0205da8 <default_pmm_manager+0xc50>
ffffffffc0203a4a:	00001617          	auipc	a2,0x1
ffffffffc0203a4e:	35e60613          	addi	a2,a2,862 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203a52:	0ed00593          	li	a1,237
ffffffffc0203a56:	00002517          	auipc	a0,0x2
ffffffffc0203a5a:	24250513          	addi	a0,a0,578 # ffffffffc0205c98 <default_pmm_manager+0xb40>
ffffffffc0203a5e:	917fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203a62:	00002697          	auipc	a3,0x2
ffffffffc0203a66:	2a668693          	addi	a3,a3,678 # ffffffffc0205d08 <default_pmm_manager+0xbb0>
ffffffffc0203a6a:	00001617          	auipc	a2,0x1
ffffffffc0203a6e:	33e60613          	addi	a2,a2,830 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203a72:	0db00593          	li	a1,219
ffffffffc0203a76:	00002517          	auipc	a0,0x2
ffffffffc0203a7a:	22250513          	addi	a0,a0,546 # ffffffffc0205c98 <default_pmm_manager+0xb40>
ffffffffc0203a7e:	8f7fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1 != NULL);
ffffffffc0203a82:	00002697          	auipc	a3,0x2
ffffffffc0203a86:	2d668693          	addi	a3,a3,726 # ffffffffc0205d58 <default_pmm_manager+0xc00>
ffffffffc0203a8a:	00001617          	auipc	a2,0x1
ffffffffc0203a8e:	31e60613          	addi	a2,a2,798 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203a92:	0e300593          	li	a1,227
ffffffffc0203a96:	00002517          	auipc	a0,0x2
ffffffffc0203a9a:	20250513          	addi	a0,a0,514 # ffffffffc0205c98 <default_pmm_manager+0xb40>
ffffffffc0203a9e:	8d7fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2 != NULL);
ffffffffc0203aa2:	00002697          	auipc	a3,0x2
ffffffffc0203aa6:	2c668693          	addi	a3,a3,710 # ffffffffc0205d68 <default_pmm_manager+0xc10>
ffffffffc0203aaa:	00001617          	auipc	a2,0x1
ffffffffc0203aae:	2fe60613          	addi	a2,a2,766 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203ab2:	0e500593          	li	a1,229
ffffffffc0203ab6:	00002517          	auipc	a0,0x2
ffffffffc0203aba:	1e250513          	addi	a0,a0,482 # ffffffffc0205c98 <default_pmm_manager+0xb40>
ffffffffc0203abe:	8b7fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma3 == NULL);
ffffffffc0203ac2:	00002697          	auipc	a3,0x2
ffffffffc0203ac6:	2b668693          	addi	a3,a3,694 # ffffffffc0205d78 <default_pmm_manager+0xc20>
ffffffffc0203aca:	00001617          	auipc	a2,0x1
ffffffffc0203ace:	2de60613          	addi	a2,a2,734 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203ad2:	0e700593          	li	a1,231
ffffffffc0203ad6:	00002517          	auipc	a0,0x2
ffffffffc0203ada:	1c250513          	addi	a0,a0,450 # ffffffffc0205c98 <default_pmm_manager+0xb40>
ffffffffc0203ade:	897fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma4 == NULL);
ffffffffc0203ae2:	00002697          	auipc	a3,0x2
ffffffffc0203ae6:	2a668693          	addi	a3,a3,678 # ffffffffc0205d88 <default_pmm_manager+0xc30>
ffffffffc0203aea:	00001617          	auipc	a2,0x1
ffffffffc0203aee:	2be60613          	addi	a2,a2,702 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203af2:	0e900593          	li	a1,233
ffffffffc0203af6:	00002517          	auipc	a0,0x2
ffffffffc0203afa:	1a250513          	addi	a0,a0,418 # ffffffffc0205c98 <default_pmm_manager+0xb40>
ffffffffc0203afe:	877fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma5 == NULL);
ffffffffc0203b02:	00002697          	auipc	a3,0x2
ffffffffc0203b06:	29668693          	addi	a3,a3,662 # ffffffffc0205d98 <default_pmm_manager+0xc40>
ffffffffc0203b0a:	00001617          	auipc	a2,0x1
ffffffffc0203b0e:	29e60613          	addi	a2,a2,670 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203b12:	0eb00593          	li	a1,235
ffffffffc0203b16:	00002517          	auipc	a0,0x2
ffffffffc0203b1a:	18250513          	addi	a0,a0,386 # ffffffffc0205c98 <default_pmm_manager+0xb40>
ffffffffc0203b1e:	857fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203b22:	00002697          	auipc	a3,0x2
ffffffffc0203b26:	d5668693          	addi	a3,a3,-682 # ffffffffc0205878 <default_pmm_manager+0x720>
ffffffffc0203b2a:	00001617          	auipc	a2,0x1
ffffffffc0203b2e:	27e60613          	addi	a2,a2,638 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203b32:	10d00593          	li	a1,269
ffffffffc0203b36:	00002517          	auipc	a0,0x2
ffffffffc0203b3a:	16250513          	addi	a0,a0,354 # ffffffffc0205c98 <default_pmm_manager+0xb40>
ffffffffc0203b3e:	837fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203b42:	00002697          	auipc	a3,0x2
ffffffffc0203b46:	3b668693          	addi	a3,a3,950 # ffffffffc0205ef8 <default_pmm_manager+0xda0>
ffffffffc0203b4a:	00001617          	auipc	a2,0x1
ffffffffc0203b4e:	25e60613          	addi	a2,a2,606 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203b52:	10a00593          	li	a1,266
ffffffffc0203b56:	00002517          	auipc	a0,0x2
ffffffffc0203b5a:	14250513          	addi	a0,a0,322 # ffffffffc0205c98 <default_pmm_manager+0xb40>
    check_mm_struct = mm_create();
ffffffffc0203b5e:	0000e797          	auipc	a5,0xe
ffffffffc0203b62:	a007b123          	sd	zero,-1534(a5) # ffffffffc0211560 <check_mm_struct>
    assert(check_mm_struct != NULL);
ffffffffc0203b66:	80ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(vma != NULL);
ffffffffc0203b6a:	00002697          	auipc	a3,0x2
ffffffffc0203b6e:	d1e68693          	addi	a3,a3,-738 # ffffffffc0205888 <default_pmm_manager+0x730>
ffffffffc0203b72:	00001617          	auipc	a2,0x1
ffffffffc0203b76:	23660613          	addi	a2,a2,566 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203b7a:	11100593          	li	a1,273
ffffffffc0203b7e:	00002517          	auipc	a0,0x2
ffffffffc0203b82:	11a50513          	addi	a0,a0,282 # ffffffffc0205c98 <default_pmm_manager+0xb40>
ffffffffc0203b86:	feefc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203b8a:	00002697          	auipc	a3,0x2
ffffffffc0203b8e:	30668693          	addi	a3,a3,774 # ffffffffc0205e90 <default_pmm_manager+0xd38>
ffffffffc0203b92:	00001617          	auipc	a2,0x1
ffffffffc0203b96:	21660613          	addi	a2,a2,534 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203b9a:	11600593          	li	a1,278
ffffffffc0203b9e:	00002517          	auipc	a0,0x2
ffffffffc0203ba2:	0fa50513          	addi	a0,a0,250 # ffffffffc0205c98 <default_pmm_manager+0xb40>
ffffffffc0203ba6:	fcefc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(sum == 0);
ffffffffc0203baa:	00002697          	auipc	a3,0x2
ffffffffc0203bae:	30668693          	addi	a3,a3,774 # ffffffffc0205eb0 <default_pmm_manager+0xd58>
ffffffffc0203bb2:	00001617          	auipc	a2,0x1
ffffffffc0203bb6:	1f660613          	addi	a2,a2,502 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203bba:	12000593          	li	a1,288
ffffffffc0203bbe:	00002517          	auipc	a0,0x2
ffffffffc0203bc2:	0da50513          	addi	a0,a0,218 # ffffffffc0205c98 <default_pmm_manager+0xb40>
ffffffffc0203bc6:	faefc0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203bca:	00001617          	auipc	a2,0x1
ffffffffc0203bce:	5c660613          	addi	a2,a2,1478 # ffffffffc0205190 <default_pmm_manager+0x38>
ffffffffc0203bd2:	06500593          	li	a1,101
ffffffffc0203bd6:	00001517          	auipc	a0,0x1
ffffffffc0203bda:	5da50513          	addi	a0,a0,1498 # ffffffffc02051b0 <default_pmm_manager+0x58>
ffffffffc0203bde:	f96fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203be2:	00002697          	auipc	a3,0x2
ffffffffc0203be6:	26668693          	addi	a3,a3,614 # ffffffffc0205e48 <default_pmm_manager+0xcf0>
ffffffffc0203bea:	00001617          	auipc	a2,0x1
ffffffffc0203bee:	1be60613          	addi	a2,a2,446 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203bf2:	12e00593          	li	a1,302
ffffffffc0203bf6:	00002517          	auipc	a0,0x2
ffffffffc0203bfa:	0a250513          	addi	a0,a0,162 # ffffffffc0205c98 <default_pmm_manager+0xb40>
ffffffffc0203bfe:	f76fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203c02:	00002697          	auipc	a3,0x2
ffffffffc0203c06:	24668693          	addi	a3,a3,582 # ffffffffc0205e48 <default_pmm_manager+0xcf0>
ffffffffc0203c0a:	00001617          	auipc	a2,0x1
ffffffffc0203c0e:	19e60613          	addi	a2,a2,414 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203c12:	0bd00593          	li	a1,189
ffffffffc0203c16:	00002517          	auipc	a0,0x2
ffffffffc0203c1a:	08250513          	addi	a0,a0,130 # ffffffffc0205c98 <default_pmm_manager+0xb40>
ffffffffc0203c1e:	f56fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(mm != NULL);
ffffffffc0203c22:	00002697          	auipc	a3,0x2
ffffffffc0203c26:	c2e68693          	addi	a3,a3,-978 # ffffffffc0205850 <default_pmm_manager+0x6f8>
ffffffffc0203c2a:	00001617          	auipc	a2,0x1
ffffffffc0203c2e:	17e60613          	addi	a2,a2,382 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203c32:	0c700593          	li	a1,199
ffffffffc0203c36:	00002517          	auipc	a0,0x2
ffffffffc0203c3a:	06250513          	addi	a0,a0,98 # ffffffffc0205c98 <default_pmm_manager+0xb40>
ffffffffc0203c3e:	f36fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203c42:	00002697          	auipc	a3,0x2
ffffffffc0203c46:	20668693          	addi	a3,a3,518 # ffffffffc0205e48 <default_pmm_manager+0xcf0>
ffffffffc0203c4a:	00001617          	auipc	a2,0x1
ffffffffc0203c4e:	15e60613          	addi	a2,a2,350 # ffffffffc0204da8 <commands+0x738>
ffffffffc0203c52:	0fb00593          	li	a1,251
ffffffffc0203c56:	00002517          	auipc	a0,0x2
ffffffffc0203c5a:	04250513          	addi	a0,a0,66 # ffffffffc0205c98 <default_pmm_manager+0xb40>
ffffffffc0203c5e:	f16fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203c62 <do_pgfault>:
...
ffffffffc0203c62:	7139                	addi	sp,sp,-64
    int ret = -E_INVAL;
    //try to find a vma which include addr
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203c64:	85b2                	mv	a1,a2
do_pgfault(struct mm_struct *mm, uint_t error_code, uintptr_t addr) {
ffffffffc0203c66:	f822                	sd	s0,48(sp)
ffffffffc0203c68:	f426                	sd	s1,40(sp)
ffffffffc0203c6a:	fc06                	sd	ra,56(sp)
...
ffffffffc0203c72:	84aa                	mv	s1,a0
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203c74:	8d1ff0ef          	jal	ra,ffffffffc0203544 <find_vma>
...
ffffffffc0203c8a:	c545                	beqz	a0,ffffffffc0203d32 <do_pgfault+0xd0>
ffffffffc0203c8c:	651c                	ld	a5,8(a0)
ffffffffc0203c8e:	0af46263          	bltu	s0,a5,ffffffffc0203d32 <do_pgfault+0xd0>
...
ffffffffc0203c92:	6d1c                	ld	a5,24(a0)
    uint32_t perm = PTE_U;
ffffffffc0203c94:	49c1                	li	s3,16
    if (vma->vm_flags & VM_WRITE) {
ffffffffc0203c96:	8b89                	andi	a5,a5,2
ffffffffc0203c98:	efb1                	bnez	a5,ffffffffc0203cf4 <do_pgfault+0x92>
        perm |= (PTE_R | PTE_W);
    }
...
ffffffffc0203ca4:	a29fd0ef          	jal	ra,ffffffffc02016cc <get_pte>
    ...
    if(ptep==NULL){
ffffffffc0203ca8:	c555                	beqz	a0,ffffffffc0203d54 <do_pgfault+0xf2>
...
ffffffffc0203cac:	c5a5                	beqz	a1,ffffffffc0203d14 <do_pgfault+0xb2>
...
ffffffffc0203cb6:	c7d9                	beqz	a5,ffffffffc0203d44 <do_pgfault+0xe2>
...
ffffffffc0203cc4:	892a                	mv	s2,a0
ffffffffc0203cc6:	e90d                	bnez	a0,ffffffffc0203cf8 <do_pgfault+0x96>
...
ffffffffc0203ccc:	86ce                	mv	a3,s3
ffffffffc0203cce:	8622                	mv	a2,s0
ffffffffc0203cd0:	ce7fd0ef          	jal	ra,ffffffffc02019b6 <page_insert>
            swap_map_swappable(mm, addr, page, 1);
ffffffffc0203cd4:	6622                	ld	a2,8(sp)
ffffffffc0203cd6:	4685                	li	a3,1
ffffffffc0203cd8:	85a2                	mv	a1,s0
ffffffffc0203cda:	8526                	mv	a0,s1
ffffffffc0203cdc:	ab4ff0ef          	jal	ra,ffffffffc0202f90 <swap_map_swappable>
            page->pra_vaddr = addr;
ffffffffc0203ce0:	67a2                	ld	a5,8(sp)
ffffffffc0203ce2:	e3a0                	sd	s0,64(a5)
   }
...
ffffffffc0203ce4:	70e2                	ld	ra,56(sp)
ffffffffc0203ce6:	7442                	ld	s0,48(sp)
ffffffffc0203ce8:	74a2                	ld	s1,40(sp)
ffffffffc0203cea:	69e2                	ld	s3,24(sp)
ffffffffc0203cec:	854a                	mv	a0,s2
ffffffffc0203cee:	7902                	ld	s2,32(sp)
ffffffffc0203cf0:	6121                	addi	sp,sp,64
ffffffffc0203cf2:	8082                	ret
        perm |= (PTE_R | PTE_W);
ffffffffc0203cf4:	49d9                	li	s3,22
ffffffffc0203cf6:	b755                	j	ffffffffc0203c9a <do_pgfault+0x38>
                cprintf("swap_in in do_pgfault failed\n");
ffffffffc0203cf8:	00002517          	auipc	a0,0x2
ffffffffc0203cfc:	29050513          	addi	a0,a0,656 # ffffffffc0205f88 <default_pmm_manager+0xe30>
ffffffffc0203d00:	bbafc0ef          	jal	ra,ffffffffc02000ba <cprintf>
}
ffffffffc0203d04:	70e2                	ld	ra,56(sp)
ffffffffc0203d06:	7442                	ld	s0,48(sp)
ffffffffc0203d08:	74a2                	ld	s1,40(sp)
...
ffffffffc0203d16:	864e                	mv	a2,s3
ffffffffc0203d18:	85a2                	mv	a1,s0
ffffffffc0203d1a:	9a7fe0ef          	jal	ra,ffffffffc02026c0 <pgdir_alloc_page>
   ret = 0;
ffffffffc0203d1e:	4901                	li	s2,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203d20:	f171                	bnez	a0,ffffffffc0203ce4 <do_pgfault+0x82>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc0203d22:	00002517          	auipc	a0,0x2
ffffffffc0203d26:	23e50513          	addi	a0,a0,574 # ffffffffc0205f60 <default_pmm_manager+0xe08>
ffffffffc0203d2a:	b90fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203d2e:	5971                	li	s2,-4
            goto failed;
ffffffffc0203d30:	bf55                	j	ffffffffc0203ce4 <do_pgfault+0x82>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc0203d32:	85a2                	mv	a1,s0
ffffffffc0203d34:	00002517          	auipc	a0,0x2
ffffffffc0203d38:	1dc50513          	addi	a0,a0,476 # ffffffffc0205f10 <default_pmm_manager+0xdb8>
ffffffffc0203d3c:	b7efc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    int ret = -E_INVAL;
ffffffffc0203d40:	5975                	li	s2,-3
        goto failed;
ffffffffc0203d42:	b74d                	j	ffffffffc0203ce4 <do_pgfault+0x82>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc0203d44:	00002517          	auipc	a0,0x2
ffffffffc0203d48:	26450513          	addi	a0,a0,612 # ffffffffc0205fa8 <default_pmm_manager+0xe50>
ffffffffc0203d4c:	b6efc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203d50:	5971                	li	s2,-4
            goto failed;
ffffffffc0203d52:	bf49                	j	ffffffffc0203ce4 <do_pgfault+0x82>
        cprintf("get_pte in do_pgfault failed\n");
ffffffffc0203d54:	00002517          	auipc	a0,0x2
ffffffffc0203d58:	1ec50513          	addi	a0,a0,492 # ffffffffc0205f40 <default_pmm_manager+0xde8>
ffffffffc0203d5c:	b5efc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203d60:	5971                	li	s2,-4
        goto failed;
ffffffffc0203d62:	b749                	j	ffffffffc0203ce4 <do_pgfault+0x82>
...
ffffffffc0203d68:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc0203d6a:	f2afc0ef          	jal	ra,ffffffffc0200494 <ide_device_valid>
ffffffffc0203d6e:	cd01                	beqz	a0,ffffffffc0203d86 <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203d70:	4505                	li	a0,1
ffffffffc0203d72:	f28fc0ef          	jal	ra,ffffffffc020049a <ide_device_size>
}
...
ffffffffc0203d8a:	24a60613          	addi	a2,a2,586 # ffffffffc0205fd0 <default_pmm_manager+0xe78>
ffffffffc0203d8e:	45b5                	li	a1,13
ffffffffc0203d90:	00002517          	auipc	a0,0x2
ffffffffc0203d94:	26050513          	addi	a0,a0,608 # ffffffffc0205ff0 <default_pmm_manager+0xe98>
...
ffffffffc0203dfe:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e00:	ea0fc06f          	j	ffffffffc02004a0 <ide_read_secs>
ffffffffc0203e04:	86aa                	mv	a3,a0
ffffffffc0203e06:	00002617          	auipc	a2,0x2
ffffffffc0203e0a:	20260613          	addi	a2,a2,514 # ffffffffc0206008 <default_pmm_manager+0xeb0>
ffffffffc0203e0e:	45d1                	li	a1,20
ffffffffc0203e10:	00002517          	auipc	a0,0x2
ffffffffc0203e14:	1e050513          	addi	a0,a0,480 # ffffffffc0205ff0 <default_pmm_manager+0xe98>
...
ffffffffc0203e26:	3c660613          	addi	a2,a2,966 # ffffffffc02051e8 <default_pmm_manager+0x90>
ffffffffc0203e2a:	00001517          	auipc	a0,0x1
ffffffffc0203e2e:	38650513          	addi	a0,a0,902 # ffffffffc02051b0 <default_pmm_manager+0x58>
ffffffffc0203e32:	d42fc0ef          	jal	ra,ffffffffc0200374 <__panic>
...
ffffffffc0203e98:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e9a:	e2afc06f          	j	ffffffffc02004c4 <ide_write_secs>
ffffffffc0203e9e:	86aa                	mv	a3,a0
ffffffffc0203ea0:	00002617          	auipc	a2,0x2
ffffffffc0203ea4:	16860613          	addi	a2,a2,360 # ffffffffc0206008 <default_pmm_manager+0xeb0>
ffffffffc0203ea8:	45e5                	li	a1,25
ffffffffc0203eaa:	00002517          	auipc	a0,0x2
ffffffffc0203eae:	14650513          	addi	a0,a0,326 # ffffffffc0205ff0 <default_pmm_manager+0xe98>
...
ffffffffc0203ec0:	32c60613          	addi	a2,a2,812 # ffffffffc02051e8 <default_pmm_manager+0x90>
ffffffffc0203ec4:	00001517          	auipc	a0,0x1
ffffffffc0203ec8:	2ec50513          	addi	a0,a0,748 # ffffffffc02051b0 <default_pmm_manager+0x58>
...
ffffffffc0203f0e:	11e78793          	addi	a5,a5,286 # ffffffffc0206028 <default_pmm_manager+0xed0>
...
ffffffffc0203f6a:	0f6a8a93          	addi	s5,s5,246 # ffffffffc020605c <default_pmm_manager+0xf04>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0203fac:	0ff5f593          	andi	a1,a1,255
...
ffffffffc0203ff0:	0ff5f593          	andi	a1,a1,255
...
ffffffffc02041c8:	e9460613          	addi	a2,a2,-364 # ffffffffc0206058 <default_pmm_manager+0xf00>
...
ffffffffc02041da:	e7260613          	addi	a2,a2,-398 # ffffffffc0206048 <default_pmm_manager+0xef0>
...
ffffffffc02041ec:	e5840413          	addi	s0,s0,-424 # ffffffffc0206040 <default_pmm_manager+0xee8>
...
ffffffffc0204276:	dce40413          	addi	s0,s0,-562 # ffffffffc0206040 <default_pmm_manager+0xee8>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
ffffffffc020428c:	db9a0a13          	addi	s4,s4,-583 # ffffffffc0206041 <default_pmm_manager+0xee9>
...
ffffffffc02042d8:	d8450513          	addi	a0,a0,-636 # ffffffffc0206058 <default_pmm_manager+0xf00>
ffffffffc02042dc:	ddffb0ef          	jal	ra,ffffffffc02000ba <cprintf>
readline(const char *prompt) {
...
ffffffffc02042f2:	3fe00a13          	li	s4,1022
        c = getchar();
ffffffffc02042f6:	dfdfb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
...
ffffffffc0204302:	029a5263          	bge	s4,s1,ffffffffc0204326 <readline+0x68>
        c = getchar();
ffffffffc0204306:	dedfb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
...
ffffffffc0204316:	e8a9                	bnez	s1,ffffffffc0204368 <readline+0xaa>
        c = getchar();
ffffffffc0204318:	ddbfb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
...
ffffffffc020436a:	d87fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            i --;
